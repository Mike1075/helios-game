        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <div style={{ 
              ...
              borderRadius: '8px',
              border: `2px solid ${selectedModel?.color || '#ddd'}`,
              fontSize: '0.9rem'
            }}>
              <div style={{
                width: '12px',
                height: '12px',
                borderRadius: '50%',
                background: selectedModel?.color || '#ddd'
              }}></div>
          ...
          <div style={{
            ...
            {messages.length === 0 && (
              <div style={{
                ...
                <h3 style={{ margin: 0, color: '#333' }}>开始与AI对话</h3>
                <p style={{ margin: 0 }}>
                  当前模型: <strong style={{color: selectedModel?.color}}>{selectedModel?.name}</strong> ({selectedModel?.provider})
                </p>
              </div>
            )}
            ...
            {isLoading && (
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ marginLeft: '0.5rem' }}>{selectedModel?.name} 正在思考...</span>
                </div>
              </div>
            )}
            <div ref={endRef} />
          ...
          <div style={{
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', gap: '1rem' }}>
              <input
                ...
                placeholder={`与 ${selectedModel?.name} 对话...`}
                disabled={isLoading}
                style={{
                  flex: 1,
                  padding: '1rem 1.5rem',
