...
-- 初始化 MVP v4.1 "创世之心" 的8个核心NPC（遵循本我之镜哲学）
insert into characters (id, name, role, core_motivation, is_player, tags) values
  ...
  ('88888888-8888-8888-8888-888888888888', '奥斯卡', '港口医师', '救死扶伤，研究草药学，为所有人提供医疗服务', false, '{"healing", "knowledge", "compassion"}')
on conflict (id) do nothing;

-- 为每个NPC初始化空的信念系统记录（v4.1 本我之镜：信念通过行为涌现）
insert into belief_systems (character_id, belief_yaml) values
  ('11111111-1111-1111-1111-111111111111', '# 艾尔文的信念系统将通过"信念观察者"从行为中发现'),
  ('22222222-2222-2222-2222-222222222222', '# 卡琳的信念系统将通过"信念观察者"从行为中发现'),
  ('33333333-3333-3333-3333-333333333333', '# 瑟兰杜斯的信念系统将通过"信念观察者"从行为中发现'),
  ('44444444-4444-4444-4444-444444444444', '# 马库斯的信念系统将通过"信念观察者"从行为中发现'),
  ('55555555-5555-5555-5555-555555555555', '# 莉莉安的信念系统将通过"信念观察者"从行为中发现'),
  ('66666666-6666-6666-6666-666666666666', '# 托马斯的信念系统将通过"信念观察者"从行为中发现'),
  ('77777777-7777-7777-7777-777777777777', '# 伊莎贝拉的信念系统将通过"信念观察者"从行为中发现'),
  ('88888888-8888-8888-8888-888888888888', '# 奥斯卡的信念系统将通过"信念观察者"从行为中发现')
