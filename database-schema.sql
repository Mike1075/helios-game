...
-- This file contains the complete database schema for the Helios game
...
-- 初始化核心角色状态
INSERT INTO character_states (character_id, energy, focus, curiosity, boredom, anxiety, suspicion) 
VALUES 
    ('linxi', 75.0, 80.0, 70.0, 20.0, 30.0, 60.0),
    ('chenhao', 60.0, 50.0, 80.0, 40.0, 25.0, 20.0)
